 ...
 */
export function vectorSearch(db, queryEmbedding, userId, topK = 5, minScore = 0.3) {
    // Fetch all memories with embeddings for this user
    const rows = db
        .prepare(`SELECT id, title, date, type, tags, therapeutic_tag, location_name, embedding
       FROM memories
